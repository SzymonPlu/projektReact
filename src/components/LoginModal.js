...
function LoginModal({ onClose }) {
  ...
  return (
    <div style={{ position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', backgroundColor: '#ffffff', padding: '20px', borderRadius: '5px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.3)', zIndex: '9999' }}>
      ...
      <button style={{ position: 'absolute', top: '5px', right: '5px', fontSize: '16px', padding: '5px', backgroundColor: 'transparent', border: 'none', cursor: 'pointer', color: '#000000' }} onClick={onClose}>X</button>
